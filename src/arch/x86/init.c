...
void init(int m, uintptr_t a) {
  ...
  // "special interprocess communication fs" which is just ramfs, create a file
  // and pass the path to a created process i can implement linux like in
  // future, but i just want something that works
